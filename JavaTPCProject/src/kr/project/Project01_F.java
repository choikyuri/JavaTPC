...
public class Project01_F {	
	...
	JLabel resAddress, resX, resY, jibunAddress; //도로명, X좌표, Y좌표, 지번변수 선언
	...
	public void initGUI() { 
		...
		JPanel pan=new JPanel(); //맨위 주소 입력부분 구현객체
		...
		//NaverMap(this):this를 통하여 resAddress, resX, resY, jibunAddress를 초기화
